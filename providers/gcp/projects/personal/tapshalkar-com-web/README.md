...
| <a name="input_enable_data_access_audit_logs"></a> [enable\_data\_access\_audit\_logs](#input\_enable\_data\_access\_audit\_logs) | Enable DATA\_READ and DATA\_WRITE audit logs. Billable beyond 50 GiB/month free tier. | `bool` | `false` | no |
| <a name="input_enabled_apis"></a> [enabled\_apis](#input\_enabled\_apis) | GCP APIs to enable | `list(string)` | <pre>[<br/>  "compute.googleapis.com",<br/>  "iam.googleapis.com",<br/>  "cloudbilling.googleapis.com",<br/>  "billingbudgets.googleapis.com",<br/>  "cloudresourcemanager.googleapis.com",<br/>  "logging.googleapis.com",<br/>  "monitoring.googleapis.com",<br/>  "iamcredentials.googleapis.com",<br/>  "storage.googleapis.com"<br/>]</pre> | no |
| <a name="input_labels"></a> [labels](#input\_labels) | Labels to apply to the project | `map(string)` | <pre>{<br/>  "env": "web",<br/>  "managed-by": "terraform"<br/>}</pre> | no |
